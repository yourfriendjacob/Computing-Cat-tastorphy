...
#there is an overfitting issue in linear kernel. A large cost correctly classifies point but also tries to classify the noise points correctly as well resulting of an overfitting issue in the train data.On the other hand, a small cost makes some errors on the noise points but performs better on test data
